...
Data buffer transmission/reception between two boards via SPI using DMA.
	...
	CLK Pin: PA.01 (A1 on CN8 connector)
	MISO Pin: PA.06 (D12 on CN5 connector)
	MOSI Pin: PA.07 (D11 on CN5 connector)
...
STM32 board's LEDs can be used to monitor the transfer status:
 ...
 - LD3 turns ON when the reception process is complete.
 - LD2 turns ON when there is an error in transmission/reception process.
...
### <b>Directory contents</b>
  ...
  - SPI/SPI_FullDuplex_ComDMA_Master/Inc/stm32u3xx_nucleo_conf.h      BSP configuration file
  - SPI/SPI_FullDuplex_ComDMA_Master/Inc/stm32u3xx_hal_conf.h   HAL configuration file
  - SPI/SPI_FullDuplex_ComDMA_Master/Inc/stm32u3xx_it.h         Interrupt handlers header file
  - SPI/SPI_FullDuplex_ComDMA_Master/Inc/main.h                       Header for main.c module
  - SPI/SPI_FullDuplex_ComDMA_Master/Src/stm32u3xx_it.c         Interrupt handlers
  - SPI/SPI_FullDuplex_ComDMA_Master/Src/main.c                       Main program
  - SPI/SPI_FullDuplex_ComDMA_Master/Src/system_stm32u3xx.c     stm32u3xx system source file
  - SPI/SPI_FullDuplex_ComDMA_Master/Src/stm32u3xx_hal_msp.c    HAL MSP file
...
### <b>Hardware and Software environment</b>
  ...
  - NUCLEO-U3C5ZI-Q Set-up
    - Connect Master board PA.01 (A1 on CN8 connector) to Slave Board PA.01 (A1 on CN8 connector)
    - Connect Master board PA.06 (D12 on CN5 connector) to Slave Board PA.06 (D12 on CN5 connector)
    - Connect Master board PA.07 (D11 on CN5 connector) to Slave Board PA.07 (D11 on CN5 connector)
