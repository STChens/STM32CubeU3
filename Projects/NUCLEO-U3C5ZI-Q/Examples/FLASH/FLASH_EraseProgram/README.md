...
The NUCLEO-U3C5ZI-Q board LEDs can be used to monitor the transfer status:  
...
### <b>Directory contents</b>
        ...
        - FLASH/FLASH_EraseProgram/Inc/stm32u3xx_nucleo_conf.h   BSP configuration file
        - FLASH/FLASH_EraseProgram/Inc/stm32u3xx_hal_conf.h      HAL Configuration file
        - FLASH/FLASH_EraseProgram/Inc/stm32u3xx_it.h            Header for stm32u3xx_it.c
        - FLASH/FLASH_EraseProgram/Inc/main.h                     Header for main.c module
        - FLASH/FLASH_EraseProgram/Src/stm32u3xx_it.c            Interrupt handlers
        - FLASH/FLASH_EraseProgram/Src/main.c                     Main program
        - FLASH/FLASH_EraseProgram/Src/stm32u3xx_hal_msp.c       MSP initialization and de-initialization
        - FLASH/FLASH_EraseProgram/Src/system_stm32u3xx.c        STM32U3xx system clock configuration file
