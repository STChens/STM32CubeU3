...
file is as follows:
     ...
     - TZEN=1
     - NSBOOTADD0 = 0x08100000
     - SECWM1_STRT=0x0  SECWM1_END=0xFF  meaning all 256 pages of Bank1 set as secure
     - SECWM2_STRT=0xFF  SECWM2_END=0x0   meaning all 256 pages of Bank2 set as secure, hence Bank2 set as non-secure

This project is targeted to run on STM32U3C5ZITxQ device on NUCLEO-U3C5ZI-Q boards from STMicroelectronics.

This project configures the maximum system clock frequency at 96 MHz in secure application.

The STM32U3C5ZITxQ board LEDs can be used to monitor the transfer status:

 - **LED_GREEN is ON** when there are no errors detected after programming in secure and non-secure areas
 - **LED_RED is blinking** when there are errors detected after programming in secure and non-secure areas
...
### <b>Directory contents</b>
      ...
      -  FLASH/FLASH_EraseProgram_TrustZone/Secure/Inc/partition_stm32u3c5xx.h            STM32U3 Device System Configuration file
...
### <b>Hardware and Software environment</b>
  ...
  - This example runs on STM32U3C5ZITxQ devices with security enabled (TZEN=1).
  ...
  - User Option Bytes requirement (with STM32CubeProgrammer tool)
        ...
        - SECWM1_STRT=0x0  SECWM1_END=0xFF  meaning all pages of Flash bank 1 set as secured
        - SECWM2_STRT=0xFF  SECWM2_END=0x0   meaning all pages of Flash bank 2 set as non-secured
