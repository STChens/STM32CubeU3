...
The SystemClock_Config() function is used to configure the system clock for STM32U3C5xx Devices :
...
##### <b>For STM32CubeIDE</b>
    In order to program the FLASH_SwapBanks_Bank1 and FLASH_SwapBanks_Bank2 projects into 0x08000000 and 0x08100000 using STM32CubeIDE, you must do the following steps:
    - Rebuild all files
    ...
    - Select the FLASH_SwapBanks_Bank2 project
        ...
        - In Use download offset(hex): Add 0x100000 to actually load the generated (.elf) file at the address 0x08100000
