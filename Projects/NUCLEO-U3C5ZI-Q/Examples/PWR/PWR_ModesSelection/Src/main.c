...
/**
  ...
  * @brief   This sample code allows the user to select the desired low power
  *          mode and be able to measure power consumption.
  ******************************************************************************
  * @attention
  *
...
/* USER CODE BEGIN PV */
LowPower_ScenarioTypeDef LowPower_Scenario;
/* USER CODE END PV */
...
int main(void)
{
  ...
  /* Print footer hyper-terminal msg */
...
/* USER CODE BEGIN 4 */
/**
  * @brief USART1 De-Initialization Function
  * @param None
  * @retval None
  */
static void USART1_UART_DeInit(void)
{
  ...
  /* USER CODE BEGIN USART1_DeInit 0 */

  /* USER CODE END USART1_DeInit 0 */

  /* USER CODE BEGIN USART1_DeInit 1 */

  /* USER CODE END USART1_DeInit 1 */
  ...
  /* USER CODE BEGIN USART1_DeInit 2 */

  /* USER CODE END USART1_DeInit 2 */
