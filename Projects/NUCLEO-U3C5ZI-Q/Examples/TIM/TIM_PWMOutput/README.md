...
The SystemClock_Config() function is used to configure the system clock for STM32U3C5ZITxQ devices :
The CPU at 96 MHz.
...
### <b>Hardware and Software environment</b>
  ...
  - NUCLEO-U3C5ZI-Q Set-up
   Connect the following pins to an oscilloscope to monitor the different waveforms:
       ...
       - TIM2_CH3 : PA.2 (pin 18 in CN10 connector)
       - TIM2_CH4 : PA.3 (pin 34 in CN10 connector)
