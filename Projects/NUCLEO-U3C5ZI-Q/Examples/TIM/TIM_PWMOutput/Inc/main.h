...
#define  PULSE1_VALUE       (uint32_t)(41 / 2)              /* Capture Compare 1 Value  */
#define  PULSE2_VALUE       (uint32_t)(41 * 37.5 / 100)     /* Capture Compare 2 Value  */
#define  PULSE3_VALUE       (uint32_t)(41 / 4)              /* Capture Compare 3 Value  */
#define  PULSE4_VALUE       (uint32_t)(41 * 12.5 /100)      /* Capture Compare 4 Value  */
