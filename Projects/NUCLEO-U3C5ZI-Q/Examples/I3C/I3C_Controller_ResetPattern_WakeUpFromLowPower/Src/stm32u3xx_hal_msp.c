...
/**
  ******************************************************************************
  * @file         I3C/I3C_Controller_ResetPattern_WakeUpFromLowPower/Src/stm32u3xx_hal_msp.c
...
void HAL_I3C_MspInit(I3C_HandleTypeDef* hi3c)
{
  ...
  */
    ...
    PeriphClkInit.I3c2ClockSelection = RCC_I3C2CLKSOURCE_MSIK;
    ...
    */
    ...
    GPIO_InitStruct.Alternate = GPIO_AF6_I3C2;
