...
How to handle I3C as Controller to send reset pattern, when Target is in low power mode.
      ...
      - SDA Pin: PB7 (Arduino D14/SDA CN5 pin 9, Morpho CN10 pin6)
...
through HAL_I3C_Ctrl_GeneratePatterns() to I3C Target. At the end of the transmission the LD1 is ON.

Then the Target wake up.

NUCLEO-U3C5ZI-Q's LEDs can be used to monitor the transfer status:

 - LD1 is ON on Controller side when the transmission of the Reset Pattern process is completed.
 - LD1 is ON on Target side when the detection of the Reset Pattern process is completed.
...
### <b>Directory contents</b>
  ...
  - I3C/I3C_Controller_ResetPattern_WakeUpFromLowPower/Inc/stm32u3xx_it.h            I3C interrupt handlers header file
...
### <b>Hardware and Software environment</b>
  ...
  - NUCLEO-U3C5ZI-Q Set-up
    ...
    - Connect I3C_SDA line of Controller board (PB7 Arduino D14/SDA CN5 pin 9, Morpho CN10 pin6) to I3C_SDA line of Target Board (PB7 Arduino D14/SDA CN5 pin 9, Morpho CN10 pin6).
