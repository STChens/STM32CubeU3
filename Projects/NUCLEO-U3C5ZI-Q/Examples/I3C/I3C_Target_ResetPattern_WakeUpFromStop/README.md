...
How to handle I3C as Target to wake up from Stop, when Target receives a reset pattern.
      ...
      - Board: NUCLEO-U3C5ZI-Q (embeds a STM32U3xx device)
      - SCL Pin: PB6 (Arduino D15/SCL CN5 pin 10, Morpho CN10 pin3)
      - SDA Pin: PB7 (Arduino D14/SDA CN5 pin 9, Morpho CN10 pin5)
...
On product STM32U3xx, the feature Reset Pattern is both functional on PWR peripheral side and on I3C peripheral.
...
The first step enable the wake up line 10 for I3C2 through HAL_PWR_EnableWakeUpLine(), then Enable I3C pull-up()
...
NUCLEO-U3C5ZI-Q's LEDs can be used to monitor the transfer status:

 - LD1 toggle slowly when there is an error in transmission/reception process.
 - LD1 ON when target wake up from Stop.
...
### <b>Directory contents</b>
  ...
  - I3C/I3C_Target_ResetPattern_WakeUpFromStop/Inc/stm32u3xx_nucleo_conf.h   BSP configuration file
  - I3C/I3C_Target_ResetPattern_WakeUpFromStop/Inc/stm32u3xx_hal_conf.h      HAL configuration file
  - I3C/I3C_Target_ResetPattern_WakeUpFromStop/Inc/stm32u3xx_it.h            I3C interrupt handlers header file
  - I3C/I3C_Target_ResetPattern_WakeUpFromStop/Inc/main.h                    Header for main.c module
  - I3C/I3C_Target_ResetPattern_WakeUpFromStop/Src/stm32u3xx_it.c            I3C interrupt handlers
  - I3C/I3C_Target_ResetPattern_WakeUpFromStop/Src/main.c                    Main program
  - I3C/I3C_Target_ResetPattern_WakeUpFromStop/Src/system_stm32u3xx.c        STM32U3xx system source file
  - I3C/I3C_Target_ResetPattern_WakeUpFromStop/Src/stm32u3xx_hal_msp.c       HAL MSP file
...
### <b>Hardware and Software environment</b>
  ...
  - NUCLEO-U3C5ZI-Q Set-up
    ...
    - Use short wire as possible between the boards or twist an independent ground wire on each I3C lines
      mean one GND twist around SCL and one GND twist around SDA to help communication at 12.5Mhz.
    - Connect I3C_SCL line of Controller board (PB6 Arduino D15/SCL CN5 pin 10, Morpho CN10 pin3) to I3C_SCL line of Target Board (PB6 Arduino D15/SCL CN5 pin 10, Morpho CN10 pin3).
    - Connect I3C_SDA line of Controller board (PB7 Arduino D14/SDA CN5 pin 9, Morpho CN10 pin5) to I3C_SDA line of Target Board (PB7 Arduino D14/SDA CN5 pin 9, Morpho CN10 pin5).
...
In order to make the program work, you must do the following :
 ...
 - Then rebuild all files and load your image into Target memory (I3C_Target_ResetPattern_WakeUpFromStop)
