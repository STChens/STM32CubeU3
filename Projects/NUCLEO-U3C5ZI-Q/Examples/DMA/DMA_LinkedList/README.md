...
This project is targeted to run on STM32U3C5ZITxQ devices on NUCLEO-U3C5ZI-Q board from STMicroelectronics.
...
NUCLEO-U3C5ZI-Q board's LED can be used to monitor the transfer status:
