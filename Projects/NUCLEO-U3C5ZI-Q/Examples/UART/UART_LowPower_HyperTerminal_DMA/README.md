...
between a board and an Hyperterminal PC application.
	...
	- Tx Pin: (available through VCP)
	- Rx Pin: (available through VCP)
...
STM32 Eval board's LEDs can be used to monitor the transfer status:
 ...
 - LD3 is ON when the reception process is complete.
 - LD2 is ON when there is an error in transmission/reception process.  
