...
### <b>Hardware and Software environment</b>
  ...
  - STM32U3C5ZITxQ Set-up
    - Connect a wire between 1st board PA2 - pin 18 of CN10 connector pin (LPUART Tx) and 2nd board PA3 - pin 34 of CN10 connector pin (LPUART Rx).
    - Connect a wire between 1st board PA3 - pin 34 of CN10 connector pin (LPUART Rx) and 2nd board PA2 - pin 18 of CN10 connector pin (LPUART Tx).
