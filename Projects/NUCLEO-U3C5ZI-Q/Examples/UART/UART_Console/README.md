...
How to use the HAL UART API for UART transmission (printf/getchar) via console with user interaction.
   ...
   - Board: NUCLEO-U3C5ZI (embeds a STM32U3C5ZI device)
...
### <b>Hardware and Software environment</b>
  ...
  - This example has been tested with one NUCLEO-U3C5ZI board embedding
    a STM32U3C5ZI device and can be easily tailored to any other supported device
    and development board.

  - NUCLEO-U3C5ZI Set-up
