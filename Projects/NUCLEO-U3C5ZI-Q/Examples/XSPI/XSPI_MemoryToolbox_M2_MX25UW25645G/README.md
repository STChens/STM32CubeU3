## <b>XSPI_MemoryToolbox_M2_MX25UW25645G Example Description</b>

How to use a XSPI Macronix  MX25UW25645G memory in memory-mapped mode.

This example demonstrates how to use an XSPI Macronix  MX25UW25645G memory in memory-mapped mode on the STM32U3 series.
It provides a reference for integrating XSPI MX25UW25645G memory in embedded applications requiring fast,
flexible, and reliable external storage.
Memory used in this example is the Macronix MX25UW25645G.
...
The MX25UW25645G memory is present on the MB1927-18BA board that is connected to the M2 connector (CN19) of the NUCLEO-U3C5ZI board.
...
- Octal DTR mode configuration for high-speed data transfers
...
Step 4: Memory specific configuration : Macronix MX25UW25645G registers

- Status register reading
- Configuration register reading.
- Configuration register writing with update value for Drive Strength (to be adapted according to used HW)
- Configuration register 2 update for Dummy Cycles
...
Memory, XSPI, Read, Write, Memory Mapped, NorFlash, DTR Mode, MX25UW25645G, M2

### <b>Directory contents</b>

      - XSPI/XSPI_MemoryToolbox_M2_MX25UW25645G/Src/main.c                     Main program
      - XSPI/XSPI_MemoryToolbox_M2_MX25UW25645G/Src/system_stm32u3xx.c         STM32U3x system source file
      - XSPI/XSPI_MemoryToolbox_M2_MX25UW25645G/Src/stm32u3xx_it.c             Interrupt handlers
      - XSPI/XSPI_MemoryToolbox_M2_MX25UW25645G/Src/stm32u3xx_hal_msp.c        Board specific setup file
      - XSPI/XSPI_MemoryToolbox_M2_MX25UW25645G/Src/memory_toolbox.c           Memory management basic services
      - XSPI/XSPI_MemoryToolbox_M2_MX25UW25645G/Inc/main.h                     Header for main.c module
      - XSPI/XSPI_MemoryToolbox_M2_MX25UW25645G/Inc/stm32u3xx_it.h             Interrupt handlers header file
      - XSPI/XSPI_MemoryToolbox_M2_MX25UW25645G/Inc/stm32u3xx_hal_conf.h       HAL Configuration file
      - XSPI/XSPI_MemoryToolbox_M2_MX25UW25645G/Inc/stm32u3xx_nucleo_conf.h    Nucleo BSP configuration file
      - XSPI/XSPI_MemoryToolbox_M2_MX25UW25645G/Src/memory_toolbox.h           Header for memory_toolbox.c module
      - XSPI/XSPI_MemoryToolbox_M2_MX25UW25645G/Src/m2_mx25uw25645g.h          Definitions for Macronix MX25UW25645G memory
...
### <b>Hardware and Software environment</b>
  ...
  - This example has been tested with STMicroelectronics NUCLEO-U3C5ZI board (MB2222) with
    MB1927-18BA board connected to the M2 connector (CN19) and can be easily tailored
    to any other supported device and development board.

  - To run this example, ensure that jumper JP2 is set to 1.8V.
