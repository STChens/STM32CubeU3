## <b>XSPI_MemoryToolbox_M2_IS25LP032D Example Description</b>

How to use a XSPI ISSI IS25LP032D memory in memory-mapped mode.

This example demonstrates how to use an XSPI IS25LP032D memory in memory-mapped mode on the STM32U3 series.
It provides a reference for integrating XSPI IS25LP032D memory in embedded applications requiring fast,
flexible, and reliable external storage.
Memory used in this example is the ISSI IS25LP032D.

This project is targeted to run on STM32U3C5xx devices on NUCLEO-U3C5ZI boards from STMicroelectronics.
...
The ISSI IS25LP032D memory is present on the MB1928-33LA board that is connected to the M2 connector (CN19) of the NUCLEO-U3C5ZI board.
...
- Dummy Cycles and Drive Strength configuration in registers
...
Init : Configures GPIO, USART1 (used for Trace system), LED, ... and configures and initializes the XSPI instance.
       Default frequency at 48 Mhz is used.
...
Step 4: Memory specific configuration : ISSI IS25LP032D registers

- Status register reading + update with QE bit enabling
- Read register reading + update of Dummy Cycles configuration (10 dummy cycles)
- Extended Read register reading + update of Drive Strength (to be adapted according to used HW)
- Clock frequency update to max supported frequency (96 Mhz) and DLYB calibration.
...
The trace output can be directed either to a UART interface (USART1 on NUCLEO-U3C5ZI board) or to the IDE debug window,
...
Memory, XSPI, Read, Write, Memory Mapped, NorFlash, IS25LP032D, M2

### <b>Directory contents</b>

      - XSPI/XSPI_MemoryToolbox_M2_IS25LP032D/Src/main.c                     Main program
      - XSPI/XSPI_MemoryToolbox_M2_IS25LP032D/Src/system_stm32u3xx.c         STM32U3x system source file
      - XSPI/XSPI_MemoryToolbox_M2_IS25LP032D/Src/stm32u3xx_it.c             Interrupt handlers
      - XSPI/XSPI_MemoryToolbox_M2_IS25LP032D/Src/stm32u3xx_hal_msp.c        Board specific setup file
      - XSPI/XSPI_MemoryToolbox_M2_IS25LP032D/Src/memory_toolbox.c           Memory management basic services
      - XSPI/XSPI_MemoryToolbox_M2_IS25LP032D/Inc/main.h                     Header for main.c module
      - XSPI/XSPI_MemoryToolbox_M2_IS25LP032D/Inc/stm32u3xx_it.h             Interrupt handlers header file
      - XSPI/XSPI_MemoryToolbox_M2_IS25LP032D/Inc/stm32u3xx_hal_conf.h       HAL Configuration file
      - XSPI/XSPI_MemoryToolbox_M2_IS25LP032D/Inc/stm32u3xx_nucleo_conf.h    Nucleo BSP configuration file
      - XSPI/XSPI_MemoryToolbox_M2_IS25LP032D/Src/memory_toolbox.h           Header for memory_toolbox.c module
      - XSPI/XSPI_MemoryToolbox_M2_IS25LP032D/Src/m2_is25lp032d.h            Definitions for ISSI IS25LP032D memory

### <b>Hardware and Software environment</b>

  - This example runs on STM32U3C5xx devices .

  - This example has been tested with STMicroelectronics NUCLEO-U3C5ZI board (MB2222) with
    MB1928-33LA board connected to the M2 connector (CN19) and can be easily tailored
    to any other supported device and development board.

  - To run this example, ensure that jumper JP2 is set to 3.3V.
