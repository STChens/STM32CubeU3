...
/* USER CODE BEGIN PFP */
static Memory_Toolbox_Status_t M2_MX25LM51245G_NorFlash_Configuration(XSPI_HandleTypeDef *hxspi);
...
int main(void)
{
  ...
  */
  ...
  EXECUTE_AND_CHECK(M2_MX25LM51245G_NorFlash_Configuration(&hxspi1));
...
/**
  * @brief  Configures the memory Macronix MX25LM51245G in Octal DTR mode + Drive Strength and Dummy cycles updates.
...
static Memory_Toolbox_Status_t M2_MX25LM51245G_NorFlash_Configuration(XSPI_HandleTypeDef *hxspi)
{
  ...
  RegBufferWrite[1] = (RegBufferRead[0] & ~M2_MX25LM51245G_REG_CR_DRIVE_STRENGH_MASK)
                      | M2_MX25LM51245G_REG_CR_DRIVE_STRENGH_VALUE ;
  Memory_Toolbox_WriteConfigRegister(hxspi, RegBufferWrite, 2U);

  /* Write Configuration Register 2 to update Dummy Cycles */
  RegBufferWrite[0] = M2_MX25LM51245G_REG_CR2_DUMMY_CYCLE_VALUE;
  Memory_Toolbox_WriteConfigRegister2(hxspi, RegBufferWrite, 1U, M2_MX25LM51245G_REG_CR2_DUMMY_CYCLE_ADDRESS);

  /* Write Configuration Register 2 to switch in Octal mode (set DOPI bit)*/
  RegBufferWrite[0] = M2_MX25LM51245G_REG_CR2_HIGH_PERF_VALUE;
  Memory_Toolbox_WriteConfigRegister2(hxspi, RegBufferWrite, 1U, M2_MX25LM51245G_REG_CR2_HIGH_PERF_ADDRESS);
