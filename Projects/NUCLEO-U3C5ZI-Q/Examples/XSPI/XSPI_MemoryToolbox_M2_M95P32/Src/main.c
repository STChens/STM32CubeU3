...
/* USER CODE BEGIN PFP */
static Memory_Toolbox_Status_t M2_M95P32_NorFlash_Configuration(XSPI_HandleTypeDef *hxspi);
...
int main(void)
{
  ...
  */
  ...
  /* Program Step 4 : Configure the EEPROM memory (Drive strength, Dummy Cycles, Quad mode) */
  EXECUTE_AND_CHECK(M2_M95P32_NorFlash_Configuration(&hxspi1));
...
/**
  * @brief  Configures the memory ST M95P32 in Quad mode + Drive Strength update.
...
static Memory_Toolbox_Status_t M2_M95P32_NorFlash_Configuration(XSPI_HandleTypeDef *hxspi)
{
  ...
  RegBufferWrite[1] = (RegBufferRead[0] & ~M2_M95P32_REG_CR_DRIVE_STRENGH_MASK) | M2_M95P32_REG_CR_DRIVE_STRENGH_VALUE;
