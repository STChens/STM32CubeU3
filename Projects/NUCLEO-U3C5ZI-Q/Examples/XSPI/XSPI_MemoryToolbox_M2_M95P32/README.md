## <b>XSPI_MemoryToolbox_M2_M95P32 Example Description</b>

How to use a XSPI ST M95P32 memory in memory-mapped mode.

This example demonstrates how to use an XSPI ST M95P32 memory in memory-mapped mode on the STM32U3 series.
It provides a reference for integrating XSPI ST M95P32 memory in embedded applications requiring fast,
flexible, and reliable external storage.
Memory used in this example is the ST M95P32.
...
The ST M95P32 memory is present on the MB1928-18LA board that is connected to the M2 connector (CN19) of the NUCLEO-U3C5ZI board.
...
Step 4: Memory specific configuration : ST M95P32
...
### <b>Directory contents</b>
      ...
      - XSPI/XSPI_MemoryToolbox_M2_M95P32/Src/main.c                     Main program
      - XSPI/XSPI_MemoryToolbox_M2_M95P32/Src/system_stm32u3xx.c         STM32U3x system source file
      - XSPI/XSPI_MemoryToolbox_M2_M95P32/Src/stm32u3xx_it.c             Interrupt handlers
      - XSPI/XSPI_MemoryToolbox_M2_M95P32/Src/stm32u3xx_hal_msp.c        Board specific setup file
      - XSPI/XSPI_MemoryToolbox_M2_M95P32/Src/memory_toolbox.c           Memory management basic services
      - XSPI/XSPI_MemoryToolbox_M2_M95P32/Inc/main.h                     Header for main.c module
      - XSPI/XSPI_MemoryToolbox_M2_M95P32/Inc/stm32u3xx_it.h             Interrupt handlers header file
      - XSPI/XSPI_MemoryToolbox_M2_M95P32/Inc/stm32u3xx_hal_conf.h       HAL Configuration file
      - XSPI/XSPI_MemoryToolbox_M2_M95P32/Inc/stm32u3xx_nucleo_conf.h    Nucleo BSP configuration file
      - XSPI/XSPI_MemoryToolbox_M2_M95P32/Src/memory_toolbox.h           Header for memory_toolbox.c module
      - XSPI/XSPI_MemoryToolbox_M2_M95P32/Src/m2_m95p32.h                Definitions for ST M95P32 memory
...
### <b>Hardware and Software environment</b>
  ...
  - This example has been tested with STMicroelectronics NUCLEO-U3C5ZI board (MB2222) with
    MB1928-18LA board connected to the M2 connector (CN19) and can be easily tailored
