...
- This project is targeted to run on STM32U3C5QI device on NUCLEO-U3C5ZI-Q board from STMicroelectronics.
...
### <b>Directory contents</b>
	...
	- Templates/TrustZoneEnabled/Secure/Inc/partition_stm32u3c5xx.h     Secure core configuration file
...
### <b>Hardware and Software environment</b>
  ...
  - This template runs on STM32U3C5ZI devices with security enabled (TZEN=1).
  - This template has been tested with STMicroelectronics NUCLEO-U3C5ZI-Q (MB2222)
  ...
  - User Option Bytes requirement (with STM32CubeProgrammer tool)
        ...
        - BOOT0 address for non-secure automatic VTOR update : NSBOOT0R = 0x08100000
        - Bank 1 watermark : SECWM1R1 : STRT=0x00  END=0xFF  meaning all pages of Flash bank 1 set as secured
        - Bank 2 watermark : SECWM2R1 : STRT=0xFF  END=0x00  meaning all pages of Flash bank 2 set as non-secured
