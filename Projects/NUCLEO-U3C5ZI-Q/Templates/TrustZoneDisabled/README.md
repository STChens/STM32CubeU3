...
- This project is targeted to run on STM32U3C5ZI device on NUCLEO-U3C5ZI-Q board from STMicroelectronics.  
...
### <b>Hardware and Software environment</b>
  ...
  - This template runs on STM32U3C5ZI devices without security enabled (TZEN=0).
