...
/**
  ...
  * @brief   CMSIS stm32u3c5xx Device Header File Initial Setup for
  *          Secure / Non-Secure Zones  for ARMCM33 based on CMSIS CORE partition_ARMCM33.h Template.
  *
  *          This file contains:
...
//     <o>End Address <0x1F-0xFFFFFFFF>
*/
#define SAU_INIT_END1       (NS_ROM_ALIAS(FLASH_TOTAL_SIZE) -1)  /* end address of SAU region 1 */
...
//     <o>Start Address <0-0xFFFFFFE0>
*/
#define SAU_INIT_START4     (SYSTEM_FLASH_BASE_NS +0x00008000)           /* start address of SAU region 4 */

/*
//     <o>End Address <0x1F-0xFFFFFFFF>
*/
#define SAU_INIT_END4       (SYSTEM_FLASH_BASE_NS + 0x0007FFFF)          /* end address of SAU region 4 */
