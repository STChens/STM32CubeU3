## <b>FIR_SEQ Application Description</b>

This application exploits the HSP Engine Middleware to demonstrate how to process a FIR in Sequencer Mode.

Several topics are covered :

  - Allocate buffers in BRAM
  - Record a Processing List with the call of the FIR processing function
  - Transfer data in BRAM
  - Execute the Processing List to process the filter
