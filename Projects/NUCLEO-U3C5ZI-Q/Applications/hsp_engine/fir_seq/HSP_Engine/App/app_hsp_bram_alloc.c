...
uint32_t MX_HSP_BRAM_Allocation(hsp_engine_context_t *hmw)
{
  ...
  g_bram_resources.fir_state_id = HSP_BRAM_MallocStateBuffer_Fir(hmw, HSP_BRAM_RSRC_FIR_STATE_TAPS_SIZE, HSP_BRAM_RSRC_INPUT_SIGNAL_SAMPLES_SIZE, HSP_BRAM_ALLOCATION_DEFAULT);
  ...
  g_bram_resources.p_coef = (float32_t *)HSP_BRAM_Malloc(hmw, HSP_BRAM_RSRC_FIR_COEF_SIZE, HSP_BRAM_ALLOCATION_DEFAULT);
