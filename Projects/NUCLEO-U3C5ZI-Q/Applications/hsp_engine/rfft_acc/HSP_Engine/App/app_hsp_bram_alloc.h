...
#define HSP_BRAM_RSRC_INPUT_SAMPLES_SIZE  512U
#define HSP_BRAM_RSRC_RFFT_RESULT_SIZE  HSP_BRAM_RSRC_INPUT_SAMPLES_SIZE
...
typedef struct {
  ...
  /* ... */
  float32_t *p_buff_rfft;
  float32_t *p_rfft_magnitude;
