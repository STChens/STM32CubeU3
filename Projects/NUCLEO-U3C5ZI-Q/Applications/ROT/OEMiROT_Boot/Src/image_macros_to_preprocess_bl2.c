...
enum image_attributes
{
  ...
  RE_BL2_WRP_END = (FLASH_HASH_REF_AREA_OFFSET - 0x1),
  RE_BL2_OEMUROT_PERSO_WRP_START = (FLASH_AREA_PERSO_OFFSET),
  RE_BL2_OEMUROT_PERSO_WRP_END = (FLASH_AREA_PERSO_OFFSET + FLASH_AREA_PERSO_SIZE - 1),
#else
  RE_BL2_WRP_START = (FLASH_AREA_PERSO_OFFSET),
  RE_BL2_WRP_END = (FLASH_AREA_BL2_OFFSET + FLASH_AREA_BL2_SIZE - 0x1),
#endif /* OEMUROT_ENABLE */

  /* U3 don't have register for HDP_START and used the SECWMx_PSTRT as such which is programmed using RE_BL2_SECx_START */
  RE_BL2_HDP_START = 0x0,
#if defined (OEMUROT_ENABLE)
  RE_BL2_HDP_END = (FLASH_HASH_REF_AREA_OFFSET - 0x1),
#else
  RE_BL2_HDP_END = (FLASH_BL2_HDP_END_OFFSET - 0x1),
#endif
  /* area for updates slot address */
