...
This application provides an example of USBX stack usage on NUCLEO-U3C5ZI-Q board,
...
When plugged to PC host, the NUCLEO-U3C5ZI-Q must be properly enumerated as an USB HID mouse device.
...
Those descriptors are used by host driver to identify the device capabilities. Once the NUCLEO-U3C5ZI-Q USB device successfully completed the enumeration phase, the device sends a HID report after a user button press.
...
### <b>Hardware and Software environment</b>
  ...
  - This application has been tested with STMicroelectronics NUCLEO-U3C5ZI-Q boards revision MB2222-U3C5ZIQ-B02 and can be easily tailored to any other supported device and development board.
