...
This application provides an example of Azure RTOS USBX stack usage on STM32U3C5xx board,
...
When plugged to PC host, the STM32U3C5xx must be properly enumerated as an USB HID mouse device.
During the enumeration phase, device provides host with the requested descriptors (Device, configuration, string).
Those descriptors are used by host driver to identify the device capabilities.
Once the STM32U3C5xx USB device successfully completed the enumeration phase, the device sends a HID report after a user button press.
...
RTOS, ThreadX, USBX Device, USB_DRD, Full Speed, HID, Mouse

### <b>Hardware and Software environment</b>

  - This application runs on STM32U3C5xx devices.
  - This application has been tested with STMicroelectronics NUCLEO-U3C5ZI boards revision MB2222-U3C5ZIQ-B02 and can be easily tailored to any other supported device and development board.
