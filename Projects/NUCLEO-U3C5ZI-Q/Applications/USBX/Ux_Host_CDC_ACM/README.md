...
- When a cdc device is plugged to  NUCLEO-U3C5ZI board, a Message will be displayed on the uart HyperTerminal (STlink VCP) showing
...
### <b>Hardware and Software environment</b>
  ...
  - This application has been tested with STMicroelectronics NUCLEO-U3C5ZI boards revision MB2222-U3C5ZIQ-B02
    and can be easily tailored to any other supported device and development board.

-  NUCLEO-U3C5ZI-Q Set-up
    - Plug the USB CDC_ACM device into the  NUCLEO-U3C5ZI board through 'Type C to A-Female' cable to the connector.
...
In order to make the program work, you must do the following :
 ...
 - Run the application
 - Click the user button to send predefined data from the Host board to the CDC evice.
