...
This application provides an example of Azure RTOS USBX stack usage on NUCLEO-U3C5ZI-Q board, it shows how to develop USB Device communication Class "CDC_ACM" based application.
...
When plugged to PC host, the NUCLEO-U3C5ZI-Q must be properly enumerated as an USB Serial device and an STlink COM port.
...
Those descriptors are used by host driver to identify the device capabilities. Once NUCLEO-U3C5ZI-Q USB device successfully completed the enumeration phase,
...
- CDC ACM non-blocking transmission by default disabled, to enable non-blocking transmission UX_DEVICE_CLASS_CDC_ACM_TRANSMISSION_DISABLE must be disabled
  and 2048 additional in USBX byte pool and USBX_DEVICE_MEMORY_STACK_SIZE.
...
RTOS, ThreadX, USBX Device, USB_DRD, Full Speed, CDC, VCP, USART.

### <b>Hardware and Software environment</b>

  - This application runs on STM32U3C5xx devices
  - This application has been tested with STMicroelectronics NUCLEO-U3C5ZI-Q boards revision: MB2222-U3C5ZIQ-B02
    and can be easily tailored to any other supported device and development board

  - NUCLEO-U3C5ZI-Q Set-up:
    - Connect the NUCLEO-U3C5ZI-Q board CN13 to the PC through "TYPE-C" to "Standard A" cable.
