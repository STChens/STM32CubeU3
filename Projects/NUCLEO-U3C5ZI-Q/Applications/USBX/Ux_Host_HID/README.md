...
When a HID device is plugged to  NUCLEO-U3C5ZI-Q board, a message will be displayed on the UART HyperTerminal showing
...
Connectivity, USBX Host, ThreadX, USB, HID, Mouse, Keyboard, UART
...
-  NUCLEO-U3C5ZI-Q Set-up
    - Plug the USB HID device into the  NUCLEO-U3C5ZI-Q board through 'Type C to A-Female' cable to the connector:
      - CN13 : to use USB Full Speed DRD IP
