...
flash_layout="$cube_fw_path/Projects/NUCLEO-U3C5ZI-Q/Applications/ROT/OEMiROT_Boot/Inc/flash_layout.h"
boot_cfg_h="$cube_fw_path/Projects/NUCLEO-U3C5ZI-Q/Applications/ROT/OEMiROT_Boot/Inc/boot_hal_cfg.h"
