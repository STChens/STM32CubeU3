...
set "flash_layout=%cube_fw_path%\Projects\NUCLEO-U3C5ZI-Q\Applications\ROT\OEMiROT_Boot\Inc\flash_layout.h"
set boot_cfg_h="%cube_fw_path%\Projects\NUCLEO-U3C5ZI-Q\Applications\ROT\OEMiROT_Boot\Inc\boot_hal_cfg.h"
...
set connect_no_reset=-c port=SWD speed=fast mode=Hotplug
...
echo        (NUCLEO-U3C5ZI-Q: disconnect CN7/Pin5 from CN7/pin7)
echo        Press any key to continue...
echo.
if [%1] neq [AUTO] pause >nul
...
:: ============================================================= End functions =============================================================
:final_execution
%stm32programmercli% %connect_hardware_reset% >> %provisioning_log% 2>>&1
echo =====
