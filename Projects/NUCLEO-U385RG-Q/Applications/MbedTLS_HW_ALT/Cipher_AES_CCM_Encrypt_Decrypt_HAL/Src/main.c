/**
  ******************************************************************************
  * @file    MbedTLS_HW_ALT/Cipher_AES_CCM_Encrypt_Decrypt_HAL/Src/main.c
  * @author  MCD Application Team
  * @brief   This example provides a short description of how to use the
  *          Mbed TLS with alt function define on HW accelerator
  ******************************************************************************
  * @attention
  *
...
int main(void)
{
  ...
  */
  ...
  /* Turn on LD2 in an infinite loop in case of AES CCM operations are successful */
  BSP_LED_On(LD2);
  glob_status = PASSED;
  while (1)
  {}
