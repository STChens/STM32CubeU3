/**
  ******************************************************************************
  * @file    MbedTLS_HW_KWE/RSA_PKCS1v1.5_Sign_KWE/Src/main.c
  * @author  MCD Application Team
  * @brief   This example provides a short description of how to use the
  *          Mbed TLS PSA opaque driver with STM32 Key Wrap Engine to wrap RSA
  *          key and use the wrapped key to compute RSA PCKS1v1.5 signature.
  ******************************************************************************
  * @attention
  *
 ...
 * RSSE keys.
 */
#define PSA_RSA_KEY_ID_USER ((psa_key_id_t)0x1fff0001)
...
int main(void)
{
  ...
  psa_set_key_id(&key_attributes, PSA_RSA_KEY_ID_USER);
