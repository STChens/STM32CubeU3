...
# Extract DUA_USER_LU
#eval "${stm32programmercli}" -c port=SWD -rssekw ./STM32CubeExpansion_RSSe_V1.1.0/RSSe/STM32U3/RSSe_KW_U375_U385_v1.0.0.bin ./Wrapped_Keys/DUA_USLU_DHUK_Sign_NS_Priv.bin KeyType=eccchiplu ExportPublicKey=No WrappingKeySelect=DHUK KeyUsage=ECDSA_USAGE_SIGN SecAttr=NON_SECURE PrivAttr=PRIVILEGE

# Extract DUA_USER_FU
eval "${stm32programmercli}" -c port=SWD -rssekw ./STM32CubeExpansion_RSSe_V1.1.0/RSSe/STM32U3/RSSe_KW_U375_U385_v1.0.0.bin ./Wrapped_Keys/DUA_USFU_DHUK_Sign_NS_Priv.bin KeyType=eccchipfu ExportPublicKey=No WrappingKeySelect=DHUK KeyUsage=ECDSA_USAGE_SIGN SecAttr=NON_SECURE PrivAttr=PRIVILEGE
