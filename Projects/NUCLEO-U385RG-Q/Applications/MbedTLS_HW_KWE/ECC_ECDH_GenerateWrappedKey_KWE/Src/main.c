/**
  ******************************************************************************
  * @file    MbedTLS_HW_KWE/ECC_ECDH_GenerateWrappedKey_KWE/Src/main.c
  * @author  MCD Application Team
  * @brief   This example provides a short description of how to use the
  *          Mbed TLS PSA opaque driver with STM32 Key Wrap Engine to 
  *          generate wrapped ECDH private key.
  ******************************************************************************
  * @attention
  *
...
int main(void)
{
  ...
  /* --------------------------------------------------------------------------
   *                    Diffie-Hellman (ECDH) Wrapped key Generation
   * PSA Persistent Private wrapped Key Generation using STM32 Key Wrap Engine
