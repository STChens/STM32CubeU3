...
#define FLASH_AREA_1_OFFSET            0x21000  /* Non-secure app image primary slot offset */

#define FLASH_AREA_1_SIZE              0x32000  /* Non-secure app image primary slot size */

#define FLASH_AREA_2_OFFSET            0x53000  /* Secure app image secondary slot */

#define FLASH_AREA_2_SIZE              0x9000   /* Secure app image secondary slot size */

#define FLASH_AREA_3_OFFSET            0x5C000  /* Non-secure app image secondary slot */
...
#define FLASH_PARTITION_SIZE           0x3B000  /* Secure and Non Secure partition size */
