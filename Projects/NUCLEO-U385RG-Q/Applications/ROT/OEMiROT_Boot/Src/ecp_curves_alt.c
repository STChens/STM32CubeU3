 ...
 *
 *  This file implements STMicroelectronics EC group load
                           ...
                           const mbedtls_mpi_uint *n,  size_t nlen)
{
    ...
    /* ST coefs group load:
       ST coef tables are big endian, whereas mpi coef tables are little endian
     */
    ...
    if (grp->A.p == NULL)
    {
        ...
        /* For HW, sign is 1 for negative value and 0 for positive value */
        grp->st_a_sign = 1U;
    }
    else
    {
        /* Other curves: A coef is positive */
