...
set "flash_layout=%cube_fw_path%\Projects\NUCLEO-U385RG-Q\Applications\ROT\OEMiROT_Boot\Inc\flash_layout.h"
set boot_cfg_h="%cube_fw_path%\Projects\NUCLEO-U385RG-Q\Applications\ROT\OEMiROT_Boot\Inc\boot_hal_cfg.h"
...
echo        (NUCLEO-U385RG-Q: disconnect CN7/Pin5 from CN7/pin7)
echo        Press any key to continue...
echo.
if [%1] neq [AUTO] pause >nul
