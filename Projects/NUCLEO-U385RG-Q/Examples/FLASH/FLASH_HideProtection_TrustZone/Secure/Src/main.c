...
/* USER CODE BEGIN PV */
uint32_t FirstPage = 0U, NbOfPages = 0U, BankNumber = 0U;
...
int main(void)
{
  ...
  /* STM32U3xx **SECURE** HAL library initialization:
  ...
  ExtHDPStruct.Bank = GetBank(FLASH_USER_START_EXT_HIDE_ADDR);
  ...
  /* Get the bank */
  BankNumber = GetBank(FLASH_USER_START_NON_HIDE_ADDR);
