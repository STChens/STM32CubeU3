...
/**
  ...
  * @brief   This example code shows how to use STM32U3xx LPTIM HAL API to realize a
...
int main(void)
{
   ...
   */
  if (HAL_LPTIM_TimeOut_Start_IT(&hlptim2, TIMEOUT) != HAL_OK)
  {
    Error_Handler();
  }
...
{
  /* Timeout was reached, toggle LD2 */
  BSP_LED_Toggle(LD2);
}
/* USER CODE END 4 */
