...
/* USER CODE BEGIN PV */
static int16_t PcmBuffer[32000U]; /* 2s */
...
static void MX_ADF1_Init(void)
{
  ...
  */
  ...
  AdfHandle0.Init.CommonParam.OutputClock.Pins = MDF_OUTPUT_CLOCK_1;
  ...
  AdfHandle0.Init.SerialInterface.ClockSource = MDF_SITF_CCK1_SOURCE;
