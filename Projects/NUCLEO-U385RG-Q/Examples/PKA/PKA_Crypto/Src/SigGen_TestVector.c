/**
  ******************************************************************************
  * @file    PKA/PKA_Crypto/Src/SigGen_TestVector.c
...
#include "main.h"
/*
 * https://github.com/pyca/cryptography/blob/main/vectors/cryptography_vectors/asymmetric/ECDSA/FIPS_186-3/SigGen.rsp
  Adapted from
  [P-256,SHA-256]
